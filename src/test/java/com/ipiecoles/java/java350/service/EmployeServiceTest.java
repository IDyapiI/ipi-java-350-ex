...
public class EmployeServiceTest {
    ...
    @ParameterizedTest
    @CsvSource({ "-10000, 200000, C123456, Le chiffre d'affaire traité ne peut être négatif ou null !",
            ", 200000, C123456, Le chiffre d'affaire traité ne peut être négatif ou null !",
            "156000, , C123456, L'objectif de chiffre d'affaire ne peut être négatif ou null !",
            "156000, -20000, C123456, L'objectif de chiffre d'affaire ne peut être négatif ou null !",
            "250000, 200000, X123456, Le matricule ne peut être null et doit commencer par un C !",
    ...
    public void testCalculPerformanceWithIllegalParams(Long caTraite, Long objectifCa, String matricule,
